...
fun MoreScreen() {
    ...
    Column (
        ...
        RMBListItem(title = stringResource(id = R.string.more_screen_item_intro_informatio), icon = Icons.Outlined.ContactSupport)
        ...
        RMBListItem(title = stringResource(id = R.string.more_screen_item_intro_informatio), icon = Icons.Outlined.Quiz)
